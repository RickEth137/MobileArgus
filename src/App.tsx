    ...
    try {
      ...
      const verified = await runSecurityVerification(
        ...
        async () => {
          ...
          console.log("⏱️ Waiting 2 seconds for RPC to sync proposal...")
            ...
            <div style={{
              ...
              {showPreferences === 'language' && (
                <div style={{ background: 'rgba(0, 0, 0, 0.25)', borderBottom: '1px solid rgba(255, 255, 255, 0.06)' }}>
                  {['English', 'Español', '中文', '日本語', '한국어', 'Français', 'Deutsch', 'Português'].map((langName) => (
                    <button
                      key={langName}
                      onClick={() => {
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <strong>⚠️ Important:</strong> Your wallet was created before seed phrase storage was implemented. Enter your backed-up 12-word recovery phrase to enable wallet derivation features.
              </div>
                    ...
                    >
                      ...
                      {showGeoTooltip && (
                        <div style={{
                          ...
                          <div style={{ fontWeight: 600, color: '#f59e0b', marginBottom: 6, fontSize: 12 }}>⚠️ Location Accuracy</div>
          ...
          <div style={{
            ...
            {swapQuote && priceImpactLevel !== 'safe' && (
              <div style={{ 
                ...
                ⚠️ Price impact: {getPriceImpactDisplay()}
              </div>
            )}
            </div>
          </div>
